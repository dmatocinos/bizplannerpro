...
class FormData
{
	...
	****************************************************/
	...
	public function BusinessFormData($registerOrUpdate)
	{
		...
		if($registerOrUpdate == 'register')
		{
			...
			$this->doesPlanExistAlready =  "bp_name = '$this->newPlanName' AND bp_user_id = '$this->bp_user_id'";
		}
		else if($registerOrUpdate == 'update')
		{
			...
			$this->queryString = "
								...
								bp_financial_start_date = '$this->bp_startDate', 
								...
								";
		} else if($registerOrUpdate == 'updatedetail')
		{
			// TOSIN UPDATE THIS BASED ON THE SETTING FORM PAGE YOU CREATE
			$this->queryString = "bp_name = '$this->newPlanName',
								 bp_financial_start_date = '$this->bp_startDate'";
		}
	...
	****************************************************/
	...
	public function LoanInvestmentFormData($registerOrUpdate)
	{
		...
		$this->type_of_funding = htmlentities(addslashes($_POST['type_of_funding']),ENT_COMPAT, "UTF-8");
