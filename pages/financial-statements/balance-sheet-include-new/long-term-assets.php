		...
		?>            
         ...
         ------------------------------------------>
              <div class="row row-item singleline">
                ...
                $balLongTermsAssets 	= $webcalc->profitlossdata['ns']['balLongTermsAssets'];
				...
				for($e_year = 0; $e_year < $_numberOfFinancialYrForcasting; $e_year++ )
				{
						...
						$acuLAssets = $balLongTermsAssets[$e_year];
				...
				?>
					<span class="cell data column-1 singleline">
						<p class="overflowable"><?php echo $open_bracket;?><?php echo $sales->defaultCurrency . ($webcalc->number($balLongTermsAssets[$e_year]) * $cancelNegative) . $closed_bracket;?> </p>	
					</span>
				<?php 					
				}// End of loop
