		...
		<?php // display empty line 
         ...
         ------------------------------------------>
              <div class="row row-group_footer singleline">
                ...
                $balTotaLiabilities	= $webcalc->profitlossdata['ns']['balTotaLiabilities'];
				...
				for($e_year = 0; $e_year < $_numberOfFinancialYrForcasting; $e_year++ )
				{
					...
					if(isset($balTotaLiabilities))
					{
						...
						if($balTotaLiabilities[$e_year] < 0)
						{
						...
						<p class="overflowable">
							<?php echo $open_bracket . $sales->defaultCurrency . number_format($balTotaLiabilities[$e_year] *$cancelNegative, 0, '.', ',') . $closed_bracket;?>
						</p>
						</span>
					<?php 
					}
