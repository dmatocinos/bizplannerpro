				...
				for($e_year = 0; $e_year < $_numberOfFinancialYrForcasting; $e_year++ )
				{
					...
					if(isset($yrAccountPayable))
					{
						...
						<span class="cell data column-1 singleline">
							<p class="overflowable"><?php echo $open_bracket . $sales->defaultCurrency . number_format(($yrAccountPayable[$e_year] * $cancelNegative), 0, '.', ',') . $closed_bracket;?> </p>	
						</span>
					<?php 
					}
					else
