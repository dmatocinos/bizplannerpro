...
include_once(TOP2);
	...
	?>
       ...
       <section class="clearfix" id="content-container">	
          ...
          <?php if(isset($_GET['personnel']) == "_employee")
				{?><div id="main-wrap">
          				<div class="dim-action-active-page" id="content">
							<div id="widgets-container" class="chapter">
                    <?php        
					include_once('human-resources/new_employee.php');
				}
				else
				{ 
					...
					<div class="page_content_right sub-content">
          				<div class="dim-action-active-page" id="content">
							<div id="widgets-container" class="chapter">
				<?php	include_once('human-resources/personnel_intro_block.php');
					
				}?>
                		<?php if(isset($_GET['personnel']) == "_employee") { }else{?>
     			 			<!-- Footer -->
                             <div id="plan-footer">
